...
(function(ns) {
    ...
    DataFlow.prototype.pluck = function(key) {
        var plucked = new DataFlow(undefined, this, key);
        var context = this;
        plucked._then(function() {
            plucked.data = _.pluckNested(context.data, key);
        });
        return plucked;
    };
    DataFlow.prototype.flatten = function() {
        var context = this;
        this.then(function() {
    ...
    DataFlow.prototype.getJSON = function(url, key) {
        this.asyncOperation(function() {
            console.log("Doing the profit dance \\o/", url);
            var context = this;
